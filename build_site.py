...
<header class="sticky-header"><div class="header-container"><div class="brand-row"><a class="brand-logo" href="/"><span class="logo-icon">🍼</span><span class="logo-text">BolagaIsm<span class="logo-tld">.uz</span></span></a><nav class="nav-actions" aria-label="Asosiy"><a class="nav-pill icon-nav" href="/qidiruv/" aria-label="Qidiruv" title="Qidiruv">🔍</a><a class="nav-pill" href="/tanlangan/" aria-label="Tanlangan ismlar">♡ <span data-fav-count>0</span></a></nav></div></div></header>
<main id="main" class="page-shell">{breadcrumb}{body}</main>
<footer class="site-footer"><div class="container"><strong>Bolagaism.uz</strong><p>Farzandingiz uchun ma'noli ism tanlang.</p><nav class="footer-links"><a href="/ogil-bola-ismlari/">O'g'il bolalar</a><a href="/qiz-bola-ismlari/">Qiz bolalar</a><a href="/manbalar/">Manbalar</a><a href="/about.html">Biz haqimizda</a><a href="/contact.html">Bog'lanish</a><a href="/privacy.html">Maxfiylik</a><a href="/terms.html">Foydalanish shartlari</a></nav><p class="footer-source">«O'zbek ismlari ma'nosi» — Begmatov E.A. O'zbekiston Milliy Ensiklopediyasi. Davlat ilmiy nashriyoti, 2007. Formulirovkalar Bolagaism.uz tahririyati tomonidan qayta bayon qilingan.</p><p>© 2026 Bolagaism.uz</p></div></footer>
