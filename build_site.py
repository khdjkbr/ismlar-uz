...
<link rel="canonical" href="{BASE}{esc(path)}"><link rel="icon" href="/favicon.ico" type="image/x-icon"><link rel="icon" href="/favicon.svg" type="image/svg+xml">
...
{('<script src="https://yandex.ru/ads/system/context.js" async></script><script data-page-id="' + esc(self.ads['autoplacement']['page_id']) + '" src="https://yandex.ru/ads/system/ap-loader.js" async></script>' if self.production and self.ads.get('autoplacement', {}).get('enabled') else '')}
...
<script>(function(m,e,t,r,i,k,a){{m[i]=m[i]||function(){{(m[i].a=m[i].a||[]).push(arguments)}};m[i].l=1*new Date();k=e.createElement(t);a=e.getElementsByTagName(t)[0];k.async=1;k.src=r;a.parentNode.insertBefore(k,a)}})(window,document,'script','https://mc.yandex.ru/metrika/tag.js','ym');ym(112365590,'init',{{clickmap:true,trackLinks:true,accurateTrackBounce:true,webvisor:true}});</script>'''
    ...
    def page(self, path, title, description, body, crumbs=None, gender='', noindex=False, modified=None, main_entity=None):
        ...
        if path != '/maqolalar/' and not path.startswith('/maqolalar/'):
            body += '<section class="video-carousel article-carousel article-teasers" aria-label="Foydali maqolalar"><div class="video-carousel-head"><div><span class="eyebrow">Foydali maqolalar</span></div><div class="video-carousel-controls"><button type="button" class="video-scroll" data-article-scroll="prev" aria-label="Oldingi maqolalar">←</button><button type="button" class="video-scroll" data-article-scroll="next" aria-label="Keyingi maqolalar">→</button></div></div><div class="video-track article-track" data-article-track><article class="video-card article-card"><a class="video-thumb article-thumb" href="/maqolalar/ism-tanlash/" aria-label="Farzandga ism tanlash"><span class="article-placeholder" aria-hidden="true">📖</span></a><h3><a href="/maqolalar/ism-tanlash/">Farzandga ism tanlash</a></h3><p>Ism ma’nosi, talaffuzi va yozilishini solishtirish bo‘yicha amaliy yo‘riqnoma.</p></article></div></section>'
...
<div class="action-row action-row-bottom"><button data-save-name="{esc(k)}" data-name-label="{esc(item['l'])}" aria-pressed="false">♡ Tanlanganlarga qo'shish</button><a class="primary" href="{esc(share)}" target="_blank" rel="noopener">Telegramda ulashish</a></div><div class="status-message" role="status" data-save-status></div></article>'''
    ...
    def support_pages(self):
        ...
        self.page('/maqolalar/', 'Foydali maqolalar | Bolagaism.uz', 'Ism tanlash va o‘zbek ismlari haqida foydali maqolalar.', '<section class="paper readable"><span class="eyebrow">Foydali maqolalar</span><h1>Ism tanlash bo‘yicha maqolalar</h1><p>Farzandingiz uchun ism tanlashda yordam beradigan tavsiyalar va tushuntirishlar.</p><div class="related-grid"><a class="catalog-tile" href="/maqolalar/ism-tanlash/"><strong>Farzandga ism tanlash</strong><span>Ism ma’nosi, talaffuzi va yozilishini solishtirish bo‘yicha amaliy yo‘riqnoma.</span></a></div></section>', [('Bosh sahifa', '/'), ('Maqolalar', '/maqolalar/')])
